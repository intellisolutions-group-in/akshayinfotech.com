...
const detailedProjects = [
  ...
  },
  {
    ...
    impact: "30% reduction in delivery path times and 40% improvement in driver device battery retention.",
  ...
  },
  {
    ...
    impact: "Page load speed decreased from 3.2s to 0.7s, resulting in a 45% increase in conversion rates.",
