  ...
  return (
    <div className="relative min-h-screen bg-[#030712] text-white pt-28 pb-16 overflow-hidden">
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center mb-8">
        <div className="p-8 md:p-12 bg-gradient-to-r from-cyan-600 to-blue-700 rounded-3xl text-white shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 h-48 w-48 bg-white/5 rounded-full blur-3xl pointer-events-none" />
          <h4 className="text-xl sm:text-2xl font-bold mb-2">Looking for a Specific Tech Skill?</h4>
          <p className="text-xs sm:text-sm text-cyan-100 mb-8 max-w-lg mx-auto font-light">Our engineers cover integrations with external APIs, custom payment setups, legacy data formats, and complex database migrations.</p>
          <Link href="/contact" className="inline-flex items-center gap-1.5 px-6 py-3 bg-white text-cyan-700 hover:bg-blue-50 transition-all rounded-xl font-bold text-xs cursor-pointer shadow-lg shadow-cyan-900/20">
            Discuss Tech Stack <ArrowRight className="h-4 w-4 text-cyan-700" />
          </Link>
        </div>
      </section>
