...
export const metadata: Metadata = {
  ...
  description: "Implement secure end-to-end encrypted databases, zero-trust token systems, HIPAA compliance guidelines, and active network penetration testing.",
  alternates: {
