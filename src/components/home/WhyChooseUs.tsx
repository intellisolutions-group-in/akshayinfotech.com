...
const cards = [
  ...
  },
  {
    ...
    icon: ShieldCheck,
    desc: "Rigorous endpoint encryption and absolute data protection.",
    features: ["Endpoint TLS/SSL encryption", "Regular penetration tests"],
  ...
  },
  {
    ...
    icon: Globe,
    desc: "Integrating high-availability multi-region hosting, and localization.",
    features: ["Multi-region hosting nodes", "Localization features"],
    accent: "rgba(139, 92, 246, 0.2)",
    iconBg: "rgba(139, 92, 246, 0.08)",
    iconColor: "#8b5cf6",
